...
**RTOS 시스템 설계 역량**    
단일 루프 방식(Super Loop)의 한계를 넘어, FreeRTOS를 통해 다중 작업을 효율적으로 스케줄링하는 방법을 익혔습니다. 특히 태스크 간 간섭을 줄이기 위한 우선순위 설계의 중요성을 체감했습니다.

**데이터 시트의 중요성**   
스텝모터 제어 문제를 해결하며, 코딩 기술만큼이나 하드웨어 데이터시트 분석이 선행되어야 물리적 제약 없는 최적의 제어가 가능하다는 점을 깊이 배웠습니다.
